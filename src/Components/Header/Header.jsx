    ...
    return (
     ...
     <div className={styles.header}>
         ...
         <svg xmlns="http://www.w3.org/2000/svg" width="15" height="43" viewBox="0 0 15 43" className={styles.arrow}>
            ...
            <div>
                <select>
                    <option>Welcome, John Smith</option>
                </select>
            </div>
            ...
            <div className="lastIcon">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23">
                    ...
                    <text id="_24" data-name="24" transform="translate(9 11)" fill="#fff" font-size="9" font-family="Roboto-Regular, Roboto" letter-spacing="-0.04em"><tspan x="0" y="0">24</tspan></text>
                </svg>
